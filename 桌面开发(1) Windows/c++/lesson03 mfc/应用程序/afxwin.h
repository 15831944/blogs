...
protected:
	...
	// 窗口过程函数声明 wanghuiyong
	virtual LRESULT WindowProc(UINT message, WPARAM wParam, LPARAM lParam);
	// 消息循环函数的声明 wanghuiyong
...
// Implementation
protected:
	CPtrList m_templateList;	// 文档模板的指针链表 wanghuiyong
...
// Attributes
	...
	CDocManager* m_pDocManager;		// 文档管理器, 维护了一个指针链表 wanghuiyong
...
protected:
	...
	afx_msg void OnFileNew();		// 命令消息响应函数 wanghuiyong
