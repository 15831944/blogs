...
template< typename T >
class CVarTypeInfo : public _CVarTypeInfo<T>
{
#if defined(_CHAR_UNSIGNED) && !defined(_ATL_ALLOW_CHAR_UNSIGNED)	
	ATLSTATIC_ASSERT(!(_CVarTypeInfo<T>::VT == static_cast<VARTYPE>(VT_I1) || _CVarTypeInfo<T>::VT == (VT_I1|VT_BYREF)), 
			"CVarTypeInfo< char > or CVarTypeInfo< char* > cannot be compiled with /J or _CHAR_UNSIGNED flag enabled");
#endif
};

template<>
class _CVarTypeInfo< char >
{
public:
...
__declspec( selectany ) char VARIANT::* const _CVarTypeInfo< char >::pmField = &VARIANT::cVal;

template<>
class _CVarTypeInfo< unsigned char >
{
public:
...
__declspec( selectany ) unsigned char VARIANT::* const _CVarTypeInfo< unsigned char >::pmField = &VARIANT::bVal;
...
__declspec( selectany ) char* VARIANT::* const _CVarTypeInfo< char* >::pmField = &VARIANT::pcVal;
...
__declspec( selectany ) unsigned char* VARIANT::* const _CVarTypeInfo< unsigned char* >::pmField = &VARIANT::pbVal;

template<>
class _CVarTypeInfo< short >
{
public:
...
__declspec( selectany ) short VARIANT::* const _CVarTypeInfo< short >::pmField = &VARIANT::iVal;
...
__declspec( selectany ) short* VARIANT::* const _CVarTypeInfo< short* >::pmField = &VARIANT::piVal;

template<>
class _CVarTypeInfo< unsigned short >
{
public:
...
__declspec( selectany ) unsigned short VARIANT::* const _CVarTypeInfo< unsigned short >::pmField = &VARIANT::uiVal;
...
__declspec( selectany ) unsigned short* VARIANT::* const _CVarTypeInfo< unsigned short* >::pmField = &VARIANT::puiVal;
#endif  // _NATIVE_WCHAR_T_DEFINED

template<>
class _CVarTypeInfo< int >
{
public:
...
__declspec( selectany ) int VARIANT::* const _CVarTypeInfo< int >::pmField = &VARIANT::intVal;
...
__declspec( selectany ) int* VARIANT::* const _CVarTypeInfo< int* >::pmField = &VARIANT::pintVal;

template<>
class _CVarTypeInfo< unsigned int >
{
public:
...
__declspec( selectany ) unsigned int VARIANT::* const _CVarTypeInfo< unsigned int >::pmField = &VARIANT::uintVal;
...
__declspec( selectany ) unsigned int* VARIANT::* const _CVarTypeInfo< unsigned int* >::pmField = &VARIANT::puintVal;

template<>
class _CVarTypeInfo< long >
{
public:
	static const VARTYPE VT = VT_I4;
...
__declspec( selectany ) long VARIANT::* const _CVarTypeInfo< long >::pmField = &VARIANT::lVal;
...
__declspec( selectany ) long* VARIANT::* const _CVarTypeInfo< long* >::pmField = &VARIANT::plVal;

template<>
class _CVarTypeInfo< unsigned long >
{
public:
	static const VARTYPE VT = VT_UI4;
...
__declspec( selectany ) unsigned long VARIANT::* const _CVarTypeInfo< unsigned long >::pmField = &VARIANT::ulVal;
...
__declspec( selectany ) unsigned long* VARIANT::* const _CVarTypeInfo< unsigned long* >::pmField = &VARIANT::pulVal;

template<>
class _CVarTypeInfo< __int64 >
{
public:
...
__declspec( selectany ) __int64 VARIANT::* const _CVarTypeInfo< __int64 >::pmField = &VARIANT::llVal;
...
__declspec( selectany ) __int64* VARIANT::* const _CVarTypeInfo< __int64* >::pmField = &VARIANT::pllVal;

template<>
class _CVarTypeInfo< unsigned __int64 >
{
public:
...
__declspec( selectany ) unsigned __int64 VARIANT::* const _CVarTypeInfo< unsigned __int64 >::pmField = &VARIANT::ullVal;
...
__declspec( selectany ) unsigned __int64* VARIANT::* const _CVarTypeInfo< unsigned __int64* >::pmField = &VARIANT::pullVal;

template<>
class _CVarTypeInfo< float >
{
public:
...
__declspec( selectany ) float VARIANT::* const _CVarTypeInfo< float >::pmField = &VARIANT::fltVal;
...
__declspec( selectany ) float* VARIANT::* const _CVarTypeInfo< float* >::pmField = &VARIANT::pfltVal;

template<>
class _CVarTypeInfo< double >
{
public:
...
__declspec( selectany ) double VARIANT::* const _CVarTypeInfo< double >::pmField = &VARIANT::dblVal;
...
__declspec( selectany ) double* VARIANT::* const _CVarTypeInfo< double* >::pmField = &VARIANT::pdblVal;

template<>

class _CVarTypeInfo< VARIANT* >
{
public:
...
__declspec( selectany ) BSTR VARIANT::* const _CVarTypeInfo< BSTR >::pmField = &VARIANT::bstrVal;
...
__declspec( selectany ) BSTR* VARIANT::* const _CVarTypeInfo< BSTR* >::pmField = &VARIANT::pbstrVal;

template<>
class _CVarTypeInfo< IUnknown* >
{
public:
...
__declspec( selectany ) IUnknown* VARIANT::* const _CVarTypeInfo< IUnknown* >::pmField = &VARIANT::punkVal;
...
__declspec( selectany ) IUnknown** VARIANT::* const _CVarTypeInfo< IUnknown** >::pmField = &VARIANT::ppunkVal;

template<>
class _CVarTypeInfo< IDispatch* >
{
public:
...
__declspec( selectany ) IDispatch* VARIANT::* const _CVarTypeInfo< IDispatch* >::pmField = &VARIANT::pdispVal;
...
__declspec( selectany ) IDispatch** VARIANT::* const _CVarTypeInfo< IDispatch** >::pmField = &VARIANT::ppdispVal;

template<>
class _CVarTypeInfo< CY >
{
public:
...
__declspec( selectany ) CY VARIANT::* const _CVarTypeInfo< CY >::pmField = &VARIANT::cyVal;
...
__declspec( selectany ) CY* VARIANT::* const _CVarTypeInfo< CY* >::pmField = &VARIANT::pcyVal;
