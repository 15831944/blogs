OBN_XT_ITEMCLICK// XTOutBarCtrl.cpp : implementation of the CXTOutBarCtrl class.
//
                ...
                case WM_LBUTTONUP:
                    {
                        ...
                        if (!bDragging)
                        {
                            ...
                            {
                                XT_OUTBAR_INFO obi;
								obi.nFolder   = m_nSelFolder;
                                obi.nIndex    = GetItemData(idx);
                                obi.nDragFrom = -1;
                                obi.nDragTo   = -1;
...
//²ÎÊýËµÃ÷£º³éÌëºÅ£¬Ë÷ÒýºÅ£¬ÎÄ×Ö£¬Í¼±êºÅ£¬data
...
//º¯ÊýËµÃ÷£º¸ù¾ÝµÚ¶þ¸ö²ÎÊýÉè¶¨ÀàÖÐÒ»´óÒ»ÏÂ2¸öCImageList£¬
//ÉèÖÃ·½Ê½ÊÇÍ¨¹ýµÚÒ»¸ö²ÎÊý´«µÝ¶øÀ´£¬Í¬Ê±·µ»ØÒÔÇ°´óµÄ»òÐ¡µÄCImageListÖ¸Õë
...
//xu		CWnd* pWndPopupOwner = this;
	...
	//	CString string;
/*remove by me		if (m_nHitInternal1 == ITEM)
		{
